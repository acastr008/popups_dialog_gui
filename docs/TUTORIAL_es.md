...
Antes que nada recomendamos echar un vistazo al documento **Visión general (ES)**: <a href="OVERVIEW_es.md">OVERVIEW_es.md</a>
...
Esta es una demo muy completa para el uso de un amplio repertorio de popups de muy fácil uso.
...
> “Este es el patrón de ayuda recomendado cuando ya usas popups: la ayuda es un popup, no un overlay externo.”
...
> “Esta es la plantilla para integrar ayuda en un sistema interactivo real: input, animación y modalidad bien resueltas.”
